...
public class AdminLoginController {
	...
	public String getRegisterUserByUserIdAndUserName(Model model, @PathVariable(value = "id") Long userId, 
    ...
    public String deleteRegisterUserByUserIdAndUserName(@PathVariable(value = "id") Long userId, 
    		@PathVariable(value = "uname") String userName) {
		UserRegistration userRegistration = null;
		FlightException flightException = null;
		if(null != userId) {
    ...
    public String registerUser(UserRegistration userRegistration) {
		...
		if(null != userRegistration) {
			if(null != userRegistration.getUserId()) {
				UserRegistration alreadyRegisteredUser = registrationUserClientProxy.getRegisterUserById(userRegistration.getUserId());
	...
	private NotificationMail createNotificationMail(UserRegistration userRegistration) {
		...
		notificationMail.setSubject("Successful Registration");
