...
public class FlightDetailsController {
	...
	public String getFlightByFlightIdAndFlightName(Model model, @PathVariable(value = "id") Long flightId, 
    ...
    public String deleteFlightByFlightIdAndFlightName(@PathVariable(value = "id") Long flightId, 
    		@PathVariable(value = "fname") String flightName) {
		FlightSearchDetails flightSearchDetails = null;
		FlightException flightException = null;
		if(null != flightId) {
